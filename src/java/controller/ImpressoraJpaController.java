...
public class ImpressoraJpaController implements Serializable {
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Impressora cliente;
            try {
                cliente = em.getReference(Impressora.class, id);
                cliente.getId();
    ...
    public List<Impressora> findClienteEntities() {
        return findClienteEntities(true, -1, -1);
    }

    public List<Impressora> findClienteEntities(int maxResults, int firstResult) {
        return findClienteEntities(false, maxResults, firstResult);
    }

    private List<Impressora> findClienteEntities(boolean all, int maxResults, int firstResult) {
    ...
    public Impressora findCliente(Integer id) {
        EntityManager em = getEntityManager();
        try {
